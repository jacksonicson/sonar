...
public class NotificationClient {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static class receive<I extends Iface> extends org.apache.thrift.ProcessFunction<I, receive_args> {
      public receive() {
        super("receive");
      }

      protected receive_args getEmptyArgsInstance() {
        return new receive_args();
      }

      protected receive_result getResult(I iface, receive_args args) throws org.apache.thrift.TException {
        receive_result result = new receive_result();
