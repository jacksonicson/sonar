...
class Client(Iface):
  ...
  def launchDrone(self, drone, hostname):
    ...
    return self.recv_launchDrone()

  def send_launchDrone(self, drone, hostname):
    self._oprot.writeMessageBegin('launchDrone', TMessageType.CALL, self._seqid)
  ...
  def recv_launchDrone(self, ):
    ...
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "launchDrone failed: unknown result");
...
class Processor(Iface, TProcessor):
  ...
  def process_launchDrone(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = launchDrone_result()
    result.success = self._handler.launchDrone(args.drone, args.hostname)
